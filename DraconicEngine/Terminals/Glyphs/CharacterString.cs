...
namespace DraconicEngine
{
    ...
    public class CharacterString : List<Character>
    {
        ...
        /// </summary>
        /// <param name="text"></param>
        public CharacterString(string text, RogueColor foreColor, RogueColor? backColor)
        {
            RogueColor originalForeColor = foreColor;
            ...
            foreach (char c in text)
            {
                ...
                if (waitingForColor)
                {
                    ...
                    {
                        foreColor = RogueColors.FromEscapeChar(c);
                    }
