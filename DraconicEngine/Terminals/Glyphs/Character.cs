...
namespace DraconicEngine
{
   public struct Character : IEquatable<Character>
   {
      ...
      /// </summary>
      public static RogueColor DefaultForeColor { get { return RogueColors.White; } }
      ...
      public static bool IsGlyph(char ascii)
      {
         return ascii >= 32 && (ascii - 32) < (int)Glyph.Box;
      }
      ...
      public static Character Parse(string text)
      {
         ...
         Glyph glyph;
         RogueColor foreColor = DefaultForeColor;
         ...
         if (parts.Length > 1)
         {
            foreColor = RogueColors.FromName(parts[0]);
         }

         // parse the back color
         if (parts.Length > 2)
         {
            backColor = RogueColors.FromName(parts[1]);
         }
      ...
      /// <param name="foreColor">Foreground <see cref="RogueColors"/> of the Character.</param>
      /// <param name="backColor">Background <see cref="RogueColors"/> of the Character.</param>
      public Character(Glyph glyph, RogueColor foreColor, RogueColor? backColor)
      {
         mGlyph = glyph;
      ...
      /// <summary>
      /// Initializes a new Character using the default background <see cref="RogueColors"/>.
      /// </summary>
      /// <param name="glyph">Glyph used to draw the Character.</param>
      /// <param name="foreColor">Foreground <see cref="RogueColors"/> of the Character.</param>
      public Character(Glyph glyph, RogueColor foreColor)
         : this(glyph, foreColor, null)
      {
      }

      /// <summary>
      /// Initializes a new Character using the default background and foreground
      /// <see cref="RogueColors"/>.
      /// </summary>
      /// <param name="glyph">Glyph used to draw the Character.</param>
      ...
      /// <param name="foreColor">Foreground <see cref="RogueColors"/> of the Character.</param>
      /// <param name="backColor">Background <see cref="RogueColors"/> of the Character.</param>
      public Character(char ascii, RogueColor foreColor, RogueColor? backColor)
      ...
      /// to draw the Character.</param>
      /// <param name="foreColor">Foreground <see cref="RogueColors"/> of the Character.</param>
      public Character(char ascii, RogueColor foreColor)
         : this(Character.ToGlyph(ascii), foreColor, null)
      {
      }
      ...
      private RogueColor mForeColor;
      private RogueColor? mBackColor;

      static readonly Character space = new Character(' ');
      public static Character Space { get { return space; } }
   }
