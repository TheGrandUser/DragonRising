...
{
   // This code was created by Eric Lippert in a series of articles that can be found here
   ...
   public static class ShadowCaster
   {
      ...
      private static Action<int, int> TranslateOrigin(Action<int, int> f, int x, int y) => (a, b) => f(a + x, b + y);
