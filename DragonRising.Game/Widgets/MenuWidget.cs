...
namespace DragonRising.Widgets
{
   ...
   class CancellableMenuWidget<TValue> : Widget
   {
      string message;
      int currentMenuItem = 0;
      int currentMenuPage = 0;
      ...
      public CancellableMenuWidget(ITerminal terminal, string message, bool compact, params MenuItem<TValue>[] items)
         : base(terminal)
      {
         if (terminal.Size.Y < (compact ? 7 : 11)) // needs room for at least three items
         {
